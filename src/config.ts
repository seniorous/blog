...
export const siteConfig: SiteConfig = {
	title: "少游的博客",
	subtitle: "去追寻吧，你所期待的那颗星",
	siteURL: "https://mizuki-sooty.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-24", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		LinkPreset.Archive,
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/seniorous",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		close: "QWQ 下次再见~", // 关闭提示
		link: "https://github.com/seniorous", // 关于链接
	},
};
